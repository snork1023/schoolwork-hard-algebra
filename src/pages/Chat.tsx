        ...
        <div className="max-w-4xl mx-auto w-full flex-1 flex flex-col">
          <div className="flex-1 bg-card rounded-lg border border-border shadow-lg overflow-hidden flex flex-col hover-glow">
            <ScrollArea className="flex-1 p-6" ref={scrollRef}>
              {messages.length === 0 ? <div className="h-full flex items-center justify-center text-center text-muted-foreground">
                  ...
                  {isLoading && messages[messages.length - 1]?.role === "assistant" && !messages[messages.length - 1]?.content && <div className="flex justify-start">
                      <div className="max-w-[80%] rounded-lg p-4 bg-secondary text-secondary-foreground">
                        <div className="flex gap-1">
                          {[0, 150, 300].map(delay => <div key={delay} className="w-2 h-2 bg-current rounded-full animate-bounce" style={{
